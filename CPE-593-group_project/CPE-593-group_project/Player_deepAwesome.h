//
//  Player_deepAwesome.h
//  CPE-593-group_project
//
//  Created by LIU YUJIE on 4/24/16.
//  Copyright © 2016 FANXUEZHOU. All rights reserved.
//

#ifndef Player_deepAwesome_h
#define Player_deepAwesome_h

#include "Weight_chart.hpp"

class Player_deepAwesome: public Player
{
private:
...
public:
    Player_deepAwesome(int d,Weight_chart *wc)
    {
        depth=d;
        weightChart = wc;
        name="deepAwesome_player(" + to_string(d) + ")";
    }
    string getName()
    {
        return name;
